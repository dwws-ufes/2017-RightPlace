package br.ufes.inf.nemo.rightplace.core.exceptions;
...
public class LoginFailedException extends Exception {
	...
	public enum LoginFailedReason {
		...
		/**
		 * Rightplace itself is OK with the authentication, but the Java EE container is not, responding with an exception.
		 */
		CONTAINER_REJECTED("containerRejected"),

		/**
		 * Rightplace could not check with the container if the authentication is OK because the HTTP request doesn't exist.
		 */
