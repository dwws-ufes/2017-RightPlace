...
import br.ufes.inf.nemo.rightplace.core.application.InstallSystemService;
...
public class InstallSystemController extends JSFController {
	...
	private RightplaceConfiguration config = new RightplaceConfiguration();
	...
	/** Getter for config. */
	public RightplaceConfiguration getConfig() {
		return config;
	}
