...
public class CoreInformation implements Serializable {
	...
	@EJB
	private RightplaceConfigurationDAO rightplaceConfigurationDAO;

	/** TODO: document this field. */
	private RightplaceConfiguration currentConfig;
	...
	public void init() {
		...
		try {
			currentConfig = rightplaceConfigurationDAO.retrieveCurrentConfiguration();
	...
	public RightplaceConfiguration getCurrentConfig() {
	...
	/** Gets a random quote from Rightplace. */
